            ...
            Card(
                ...
                child: Container(
                  ...
                  child: GestureDetector(onTap: ()=>{
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>AskView()))
...
""".replaceAll(RegExp("\n"), ""),maxLines: 3,overflow: TextOverflow.ellipsis,),
                    ...
                    Row(
                      ...
                      children: [Tag(text: "李翔",icon: Icons.person,color1: Colors.deepPurpleAccent.withOpacity(0.8),textColor: Colors.grey.shade700,),Spacer(),buildtag("老师问", SQColor.orange,CupertinoIcons.heart_circle_fill),buildtag("未回答", SQColor.blue,CupertinoIcons.clear_thick_circled),
                      ],
                    )
                  ]),
                )),
...
""".replaceAll(RegExp("\n"), ""),maxLines: 3,overflow: TextOverflow.ellipsis,),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [Tag(text: "李翔",icon: Icons.person,color1: Colors.deepPurpleAccent.withOpacity(0.8),textColor: Colors.grey.shade700,),Spacer(),buildtag("老师答", SQColor.golden,CupertinoIcons.checkmark_seal_fill),
                      ],
                    )
                  ]),
...
""".replaceAll(RegExp("\n"), ""),maxLines: 3,overflow: TextOverflow.ellipsis,),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [Tag(text: "无法可说",icon: Icons.person,color1: Colors.deepPurpleAccent.withOpacity(0.8),textColor: Colors.grey.shade700,),Spacer(),buildtag("已回答", SQColor.secondary,CupertinoIcons.check_mark_circled_solid),
                      ],
                    )
                  ]),
...
""".replaceAll(RegExp("\n"), ""),maxLines: 3,overflow: TextOverflow.ellipsis,),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [Tag(text: "无法可说",icon: Icons.person,color1: Colors.deepPurpleAccent.withOpacity(0.8),textColor: Colors.grey.shade700,),Spacer(),buildtag("老师问", SQColor.orange,CupertinoIcons.heart_circle_fill),buildtag("已回答", SQColor.secondary,CupertinoIcons.check_mark_circled_solid),
                      ],
                    )
                  ]),
