...
class Pre {
  ...
  Widget getPreWidget(m.Node node) {
    ...
    final preWidget = Container(
      ...
      padding: preConfig?.padding ?? const EdgeInsets.fromLTRB(10, 30, 10, 30),
      width: double.infinity,
      child: SingleChildScrollView(
        scrollDirection: Axis.horizontal,clipBehavior: Clip.antiAlias,primary: true ,
        child: HighlightView(
          node.textContent,
...
class HighlightView extends StatelessWidget {
  ...
  HighlightView(
    String input, {
    this.language,
    this.autoDetectionLanguage=true,
    this.theme = const {},
    this.textStyle,
